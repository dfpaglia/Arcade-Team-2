...
public class Animator {
	...
	/**
	 * getNumberOfFrames(String action)
	 * 
	 * @param action
	 * @return
	 */
	public int getNumberOfFrames(String action) {
		return sprite.getFrameData(action).getNumberOfFrames();
	}
	
	/**
	 * getCurrentFrameIndex()
	 * 
	 * @return The index of the current frame being drawn.
	 */
