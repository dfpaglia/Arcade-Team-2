...
//			System.out.println();
//			System.out.println( "Getting Frame " + i + " of action at row " + row );
//			System.out.println( "SizeX * i + i * paddingX = " + ((i * size_x) + (i * padding_x)) );
//			System.out.println("Furthest X value for frame is " 
//					+ ((i * size_x) + (i * padding_x) + size_x) );
//			System.out.println( "SizeY * i + i * paddingY = " + ((i * size_y) + (i * padding_y)) );
//			System.out.println( "Furthest Y value for frame is = " 
//					+ ((row * size_y) + (row * padding_y) + size_y) );
